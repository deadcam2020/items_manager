...
const ShoppingCart = () => {
  ...
  if (loading) return <CustomFullScreenLoading message={"Cargando"}/>
  ...
  if(cartProducts.length === 0) return <CustomFullScreenMessage message="No has agregado productos al carrito"/>
